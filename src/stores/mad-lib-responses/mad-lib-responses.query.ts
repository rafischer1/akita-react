...
export const getResponseByControlId$ = (id: string | undefined): Observable<string> => madLibResponsesQuery.select(state => {
    ...
    return val ? val.value ? val.value : "No VAL.Value found" : "No VAL found";
});
