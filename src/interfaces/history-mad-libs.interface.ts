...
export const historyMadLibs:HistoryMadLib[] = [
    {id: 1, title: "William Shakespeare", categories: [1, 5],
        template: [{tag: "div", className: "", text:"This author's name is:", controlId: 1}],
    ...
    {id: 2, title: "Moon Landing", categories: [8,7,4,3],
        template: [{tag: "h1", className: "title", text: "About the Moon Landing...", controlId: 1},
            {tag: "h4", className: "date", text: "On the morning of ....", controlId: 2}],
